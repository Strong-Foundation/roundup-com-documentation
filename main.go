...
func main() {
	remoteAPIURL := "https://www.roundup.com.au/materials-safety-data-sheets" // URL to fetch HTML content from
	localFilePath := "roundup.html"                                       // Path where HTML file will be stored
